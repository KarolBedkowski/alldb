...
class _MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.main_frame_toolbar.AddLabelTool(2001, _("New item"), wx.NullBitmap, wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        # Tool Bar end
        ...
        self.Bind(wx.EVT_TOOL, self._on_tb_new_item, id=2001)
    ...
    def __do_layout(self):
        ...
        self.window_1.SplitVertically(self.clb_tags, self.window_2, 104)
    ...
    def _on_tb_new_item(self, event): # wxGlade: _MainFrame.<event_handler>
        print "Event handler `_on_tb_new_item' not implemented!"
        event.Skip()
