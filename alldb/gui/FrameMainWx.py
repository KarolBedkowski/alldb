...
class FrameMainWx(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.list_items = wx.ListCtrl(self.window_2, -1, style=wx.LC_REPORT|wx.LC_AUTOARRANGE|wx.LC_SINGLE_SEL|wx.NO_BORDER)
    ...
    def __do_layout(self):
        ...
        self.window_1.SplitVertically(self.clb_tags, self.window_2, 203)
