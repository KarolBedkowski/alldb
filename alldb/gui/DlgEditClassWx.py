...
class DlgEditClassWx(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.cb_show_title = wx.CheckBox(self, -1, _("Item have title"))
    ...
    def __do_layout(self):
        ...
        sizer_main.Add(sizer_7, 0, wx.LEFT|wx.RIGHT|wx.EXPAND, 6)
        sizer_main.Add(self.cb_title_in_list, 0, wx.LEFT|wx.RIGHT|wx.BOTTOM, 6)
