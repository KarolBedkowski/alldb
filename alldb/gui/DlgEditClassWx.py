...
class DlgEditClassWx(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.cb_title_auto = wx.CheckBox(self, -1, _("Create title expresion:"))
        self.label_8 = wx.StaticText(self, -1, _("Title expression:"))
        self.tc_title = wx.TextCtrl(self, -1, "")
        self.cb_title_in_list = wx.CheckBox(self, -1, _("Show title in items list"))
    ...
    def __do_layout(self):
        ...
        sizer_main.Add(self.label_1, 0, wx.TOP, 6)
        sizer_16_copy.Add(self.cb_show_title, 0, wx.TOP|wx.BOTTOM, 3)
        sizer_16_copy.Add(self.cb_title_auto, 0, wx.TOP|wx.BOTTOM|wx.ALIGN_CENTER_VERTICAL, 3)
        sizer_7.Add(self.label_8, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_7.Add(self.tc_title, 1, wx.ALL, 6)
        sizer_16_copy.Add(sizer_7, 0, wx.RIGHT|wx.EXPAND, 3)
        sizer_16_copy.Add(self.cb_title_in_list, 0, wx.TOP|wx.BOTTOM, 3)
        sizer_main.Add(sizer_16_copy, 0, wx.LEFT|wx.EXPAND, 6)
        sizer_main.Add(self.label_3, 0, wx.TOP, 6)
        ...
        sizer_16.Add(sizer_main, 1, wx.ALL|wx.EXPAND, 6)
